...
public class HttpUtils {
	...
	public static String parseParams(Map<String, Object> params) {
		...
		for (String key : params.keySet()) {
			result.append(key).append("=").append(params.get(key).toString()).append("&");
		}
    ...
    public static String getAuth() {
        ...
        String clientId = "LUk43p2mtGs8kibZ7xZRw3tw";
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = "LOynVphgA32VEh7Hjx1Sfj5lG3x8MVHt";
