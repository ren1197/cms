...
<link rel="stylesheet" href="${ctx}/bootstrap/css/bootstrap.css"
	type="text/css"></link>
<link rel="stylesheet"
	href="${ctx}/bootstrap/css/bootstrap-responsive.css"></link>
...
.change {
	...
	FILTER: progid:DXImageTransform.Microsoft.Gradient(gradientType=0,
		startColorStr=#FFF, endColorStr=#D1BBFF); /*IE*/
	background: -moz-linear-gradient(top, #FFF, #D1BBFF); /*火狐*/
	background: -webkit-gradient(linear, 0% 39.1%, 0% 100%, from(#FFF),
		to(#D1BBFF)); 
}
</style>
		...
		<div class="modal" id="login">
			...
			<div class="modal-body">
				<form id="form1" class="form-horizontal"
					action="${ctx}/Login/tomain.do" method="post">
