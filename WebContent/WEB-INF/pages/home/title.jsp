	    ...
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
			    	...
			    	<div id="mask">
			    		<div id="menuContent">
<!-- 			    		<span id="topmenu"
onclick="top.location.href='fmain.action';linkHighlightMenu(this);">系统首页</span> -->
<span id="tm_separator"></span>
<!-- <span id="topmenu" 
onclick="top.leftFrame.location.href='cargoLeft.action';top.main.location.href='cargoMain.action';linkHighlightMenu(this);">货运管理</span><span id="tm_separator"></span> -->

<!-- <span id="topmenu" 
onclick="top.leftFrame.location.href='sysadminLeft.action';top.main.location.href='sysadminMain.action';linkHighlightMenu(this);">系统管理</span><span id="tm_separator"></span> -->
<span id="topmenu" 
onclick="top.leftFrame.location.href='contentLeft.action';top.main.location.href='contentMain.action';linkHighlightMenu(this);">内容管理</span>
<span id="topmenu"
    onclick="top.leftFrame.location.href='${ctx}/Barticlecategory/content/tree.action';top.main.location.href='contentMain.action';linkHighlightMenu(this);">文章查看</span>
