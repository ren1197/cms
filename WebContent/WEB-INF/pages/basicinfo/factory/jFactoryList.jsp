					...
					<table id="ec_table" class="tableRegion" width="98%">
							...
							<c:forEach items="${factoryList}" var="o" varStatus="status">
								<tr class="odd" onmouseover="this.className='highlight'"
									...
									<td><c:if test="${o.state==0}">
											...
											<a href="stop.action?id=${o.id}"><font color="orange">启用</font></a>
										</c:if></td>
								</tr>
							</c:forEach>
						...
						<tr>
							<td colspan="3" align="center">
								...
								&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath }/basicinfo/factory/jFactoryList?currentPage=1">首页</a>
								<a
								href="${pageContext.request.contextPath }/basicinfo/factory/jFactoryList?currentPage=${requestScope.pageBean.currentPage-1}">上一页
							</a> <a
								href="${pageContext.request.contextPath }/basicinfo/factory/jFactoryList?currentPage=${requestScope.pageBean.currentPage+1}">下一页
							</a> <a
								href="${pageContext.request.contextPath }/basicinfo/factory/jFactoryList?currentPage=${requestScope.pageBean.totalPage}">末页</a>
							</td>
						</tr>
