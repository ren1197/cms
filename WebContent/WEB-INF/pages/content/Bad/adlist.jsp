				...
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
                           ...
                           <li id="new"><a href="${pageContext.request.contextPath }/recycle/content/adList.action">回收站</a></li>
						</ul>
					</div>
				</div>
			</div>
              ...
              <span class="noprint">
				...
				<div class="eXtremeTable">
					<table id="ec_table" class="tableRegion" width="98%">
						...
						<tbody class="tableBody">
							...
							<c:forEach items="${page.rows}" var="item" varStatus="status">
								<tr class="odd" onmouseover="this.className='highlight'"
		                           ...
		                           src="${pageContext.request.contextPath }/image/${item.path}" /></a> </td>
                     ...
                     <div >
					<atcast:page url="${pageContext.request.contextPath }/Bad/content/tolist.action" />
				   </div>
				</div>
