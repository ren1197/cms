				...
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
			     		    ...
			     		    <li id="new"><a href="#"
								onclick="formSubmit('recover.action','_self');this.blur();">恢复</a></li>
							
							<li id="delete"><a href="#"
								onclick="formSubmit('deletem.action','_self');this.blur();">删除</a></li>
					...
					<table id="ec_table" class="tableRegion" width="98%" >
						<thead>
							<tr>
								...
								<td class="tableHeader">文章目前状态</td>
                           ...
                           <input type="hidden" name="orders" value="${item.id}">
							<c:forEach items="${page.rows}" var="item" varStatus="status">
								<tr class="odd" onmouseover="this.className='highlight'"
		                           ...
		                           src="${pageContext.request.contextPath }/image/${item.fmimg}" />
</td>
		                          ...
		                          <td><c:if test="${item.state==1}">
										...
										<td>
										<c:if test="${item.isdel==0}"><font class="layui-btn layui-btn-radius layui-btn-danger">已删除</font></c:if>
